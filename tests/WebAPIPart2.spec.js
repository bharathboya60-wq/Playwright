...
// reuse authenticated storage across tests
...
test("End to End Test", async function(){
    const product = "ZARA COAT 3";
    const page = await WebContext.newPage();
    await page.goto("https://rahulshettyacademy.com/client/");
    const Products = page.locator(".card-body");
     // wait for all network requests to finish(but this flaky)
...
test("Titles Test", async function(){
    const page = await WebContext.newPage();
    await page.goto("https://rahulshettyacademy.com/client/");
